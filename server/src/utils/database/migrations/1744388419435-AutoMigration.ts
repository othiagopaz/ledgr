...
export class AutoMigration1744388419435 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."transactions_status_enum" AS ENUM('PENDING', 'PAID', 'OVERDUE', 'CANCELLED', 'SCHEDULED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."accounts_type_enum" AS ENUM('CHECKING', 'SAVINGS', 'WALLET', 'INVESTMENT', 'OTHER')`,
    );
    await queryRunner.query(
