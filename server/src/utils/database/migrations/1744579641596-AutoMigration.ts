...
export class AutoMigration1744579641596 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."settlements_status_enum" AS ENUM('EXPECTED', 'PAID', 'CANCELED')`);
        await queryRunner.query(`CREATE TYPE "public"."settlements_direction_enum" AS ENUM('RECEIVABLE', 'PAYABLE')`);
